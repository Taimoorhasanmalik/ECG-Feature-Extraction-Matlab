%% Train sequence-level Normal vs Abnormal gate from Q3.8 window SVM scores
% Abnormal = VT or VF rhythm. All other rhythms are treated as Normal.
% This lightweight second-stage gate keeps the existing window features,
% then trains on features computed from consecutive window scores.
% Features:
%   1. abnormal_vote_count: count of abnormal base-window decisions
%   2. max_score: maximum base-window abnormal score
%   3. sum_score: sum of base-window abnormal scores
%   4. score_delta: last score minus first score
%   5. min_score: minimum base-window abnormal score
...
[trainSequenceAll_X, trainSequence_Y, trainSequence_record_ids] = make_sequence_gate_features( ...
    baseTrainScores(:, 2), train_Y_raw, train_record_ids_raw, train_window_numbers_raw, ...
