...
modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_recall90_robust_lsvm";
if cleanTrainingEnabled
    modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_recall90_clean_lsvm";
end
