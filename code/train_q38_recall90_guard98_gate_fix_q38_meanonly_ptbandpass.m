%% Train Normal vs Abnormal using causal Pan-Tompkins bandpass and fix Q3.8 mean-only features
...
% to signed Q3.8 using fix(), applies a causal 5-15 Hz Pan-Tompkins-style
% bandpass, then quantizes mean values only after sum/windowLength division
...
modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_fix_meanonly_ptbandpass_recall90_guard98_robust_lsvm";
if cleanTrainingEnabled
    modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_fix_meanonly_ptbandpass_recall90_guard98_clean_lsvm";
end
...
save(modelFile, ...
    ...
    'quantizationMax', ...
    'preprocessingMode', ...
    'preprocessingBandpassLowHz', ...
    'preprocessingBandpassHighHz', ...
    'preprocessingBandpassOrder', ...
    'windowSeconds', ...
    'stepSeconds', ...
