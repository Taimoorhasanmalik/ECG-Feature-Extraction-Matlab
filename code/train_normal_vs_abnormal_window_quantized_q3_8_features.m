%% Train Normal vs Abnormal using Q3.8-quantized moving-window features
...
modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_robust_lsvm";
if cleanTrainingEnabled
    modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_clean_lsvm";
end
...
thresholdObjectiveCandidates = {'f1'};
...
fprintf('Threshold objective: %s | Recall floor disabled\n', thresholdObjective);
...
fprintf('Selection objective: maximize CV accuracy; no recall floor.\n');
    ...
    for boxIdx = 1:length(boxCandidates)
        ...
        for weightIdx = 1:length(classWeightModeCandidates)
            ...
            for thresholdIdx = 1:length(thresholdObjectiveCandidates)
                ...
                tuningResults(resultIdx).selection_score = cvResults.mean_accuracy;
