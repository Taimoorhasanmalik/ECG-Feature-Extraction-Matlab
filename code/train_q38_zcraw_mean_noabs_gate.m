%% Train Normal vs Abnormal using Q3.8-quantized raw-zero-crossing window features without mean_abs, recall-focused
...
% Features:
%   1. window_mean: mean ECG amplitude inside the quantized window
%   2. zero_crossings: zero-crossing rate of the demeaned ECG window
...
modelStem = "stage1_q38_zcraw_mean_noabs_recall95_lsvm";
if cleanTrainingEnabled
    modelStem = "stage1_q38_zcraw_mean_noabs_recall95_clean_lsvm";
end
...
excludedFeatureNames = ["mean_abs"; "rms_amplitude"];
