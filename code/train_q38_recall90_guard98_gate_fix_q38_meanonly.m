%% Train Normal vs Abnormal using fix Q3.8 signal and mean-only feature quantization
...
% to signed Q3.8 using fix(), then quantizes mean values only after
% sum/windowLength division during feature extraction.
% Features:
...
modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_fix_meanonly_recall90_guard98_robust_lsvm";
if cleanTrainingEnabled
    modelStem = "stage1_normal_vs_abnormal_window_quantized_q3_8_fix_meanonly_recall90_guard98_clean_lsvm";
end
...
quantizationStageMode = 'signal_and_window_mean_only';
